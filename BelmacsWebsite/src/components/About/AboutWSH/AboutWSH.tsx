        ...
        <div className="wsh-card">
          <div className="wsh-card-background-two">
            <div className="wsh-card-text two">
              ...
              <p className="wsh-card-desc">
                Adopting the best practices and continuously improving health
                and safety standards to prevent injury and ill health
              </p>
            </div>
          </div>
        </div>
        <div className="wsh-card three">
          <div className="wsh-card-background-three">
            <div className="wsh-card-text three">
              ...
              <p className="wsh-card-desc">
                Educating and training our employees on the importance of safety
                and health
              </p>
            </div>
          </div>
